 ...
 * </p>
 * <ul>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getId <em>Id</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getProject <em>Project</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getRevisions <em>Revisions</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getSize <em>Size</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getDate <em>Date</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getLastError <em>Last Error</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#isClear <em>Clear</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getUser <em>User</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getIfcHeader <em>Ifc Header</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getMinBounds <em>Min Bounds</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getMaxBounds <em>Max Bounds</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ConcreteRevisionImpl#getOidCounters <em>Oid Counters</em>}</li>
 * </ul>
 *
 * @generated
 */
