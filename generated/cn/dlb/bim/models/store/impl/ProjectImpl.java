...
import cn.dlb.bim.models.store.ConcreteRevision;
import cn.dlb.bim.models.store.ExtendedData;
import cn.dlb.bim.models.store.GeoTag;
import cn.dlb.bim.models.store.ModelCheckerInstance;
import cn.dlb.bim.models.store.NewService;
import cn.dlb.bim.models.store.ObjectState;
import cn.dlb.bim.models.store.Project;
import cn.dlb.bim.models.store.Revision;
import cn.dlb.bim.models.store.SIPrefix;
import cn.dlb.bim.models.store.Service;
 ...
 * </p>
 * <ul>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getId <em>Id</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getHasAuthorizedUsers <em>Has Authorized Users</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getConcreteRevisions <em>Concrete Revisions</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getRevisions <em>Revisions</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getLastConcreteRevision <em>Last Concrete Revision</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getLastRevision <em>Last Revision</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getCheckouts <em>Checkouts</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getState <em>State</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getCreatedDate <em>Created Date</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getCreatedBy <em>Created By</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getGeoTag <em>Geo Tag</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getSubProjects <em>Sub Projects</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getExportLengthMeasurePrefix <em>Export Length Measure Prefix</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getExtendedData <em>Extended Data</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getServices <em>Services</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getLogs <em>Logs</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getModelCheckers <em>Model Checkers</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#isSendEmailOnNewRevision <em>Send Email On New Revision</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ProjectImpl#getNewServices <em>New Services</em>}</li>
 * </ul>
 *
 * @generated
 */
