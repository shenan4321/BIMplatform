...
import cn.dlb.bim.models.store.WebModulePluginConfiguration;
 ...
 * </p>
 * <ul>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#isSendConfirmationEmailAfterRegistration <em>Send Confirmation Email After Registration</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getAllowSelfRegistration <em>Allow Self Registration</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#isAllowUsersToCreateTopLevelProjects <em>Allow Users To Create Top Level Projects</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getCheckinMergingEnabled <em>Checkin Merging Enabled</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getSmtpServer <em>Smtp Server</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getEmailSenderAddress <em>Email Sender Address</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getEmailSenderName <em>Email Sender Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getSiteAddress <em>Site Address</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#isGenerateGeometryOnCheckin <em>Generate Geometry On Checkin</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#isAllowOnlyWhitelisted <em>Allow Only Whitelisted</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getWhitelistedDomains <em>Whitelisted Domains</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getHideUserListForNonAdmin <em>Hide User List For Non Admin</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getProtocolBuffersPort <em>Protocol Buffers Port</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getCacheOutputFiles <em>Cache Output Files</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getWebModules <em>Web Modules</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getWebModule <em>Web Module</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getServiceRepositoryUrl <em>Service Repository Url</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#isSendEmailOnNewRevision <em>Send Email On New Revision</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getSessionTimeOutSeconds <em>Session Time Out Seconds</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getSmtpUsername <em>Smtp Username</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getSmtpPassword <em>Smtp Password</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getSmtpPort <em>Smtp Port</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getSmtpProtocol <em>Smtp Protocol</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#isReuseGeometry <em>Reuse Geometry</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#isAllowCreateValidatedUser <em>Allow Create Validated User</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getRenderEngineProcesses <em>Render Engine Processes</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#isPluginStrictVersionChecking <em>Plugin Strict Version Checking</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getName <em>Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServerSettingsImpl#getIcon <em>Icon</em>}</li>
 * </ul>
 *
 * @generated
 */
