...
import cn.dlb.bim.models.store.ServiceDescriptor;
 ...
 * </p>
 * <ul>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getName <em>Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getToken <em>Token</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getNotificationProtocol <em>Notification Protocol</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#isReadRevision <em>Read Revision</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getReadExtendedData <em>Read Extended Data</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#isWriteRevision <em>Write Revision</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getWriteExtendedData <em>Write Extended Data</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getProviderName <em>Provider Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getCompanyUrl <em>Company Url</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getTokenUrl <em>Token Url</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getNewProfileUrl <em>New Profile Url</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getRegisterUrl <em>Register Url</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceDescriptorImpl#getAuthorizeUrl <em>Authorize Url</em>}</li>
 * </ul>
 *
 * @generated
 */
