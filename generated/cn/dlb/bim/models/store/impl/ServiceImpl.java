...
import cn.dlb.bim.models.store.ExtendedDataSchema;
...
import cn.dlb.bim.models.store.Trigger;
 ...
 * </p>
 * <ul>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getName <em>Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getServiceIdentifier <em>Service Identifier</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getProviderName <em>Provider Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getToken <em>Token</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getNotificationProtocol <em>Notification Protocol</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#isReadRevision <em>Read Revision</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getReadExtendedData <em>Read Extended Data</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getWriteRevision <em>Write Revision</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getWriteExtendedData <em>Write Extended Data</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getProfileIdentifier <em>Profile Identifier</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getProfileName <em>Profile Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getProfileDescription <em>Profile Description</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#isProfilePublic <em>Profile Public</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getProject <em>Project</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getUser <em>User</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getInternalService <em>Internal Service</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.ServiceImpl#getModelCheckers <em>Model Checkers</em>}</li>
 * </ul>
 *
 * @generated
 */
