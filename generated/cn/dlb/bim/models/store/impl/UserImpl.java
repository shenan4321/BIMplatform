...
import cn.dlb.bim.models.store.OAuthAuthorizationCode;
...
import cn.dlb.bim.models.store.UserType;
 ...
 * </p>
 * <ul>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getName <em>Name</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getPasswordHash <em>Password Hash</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getPasswordSalt <em>Password Salt</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getHasRightsOn <em>Has Rights On</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getRevisions <em>Revisions</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getState <em>State</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getCreatedOn <em>Created On</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getCreatedBy <em>Created By</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getUserType <em>User Type</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getLastSeen <em>Last Seen</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getToken <em>Token</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getValidationToken <em>Validation Token</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getValidationTokenCreated <em>Validation Token Created</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getUserSettings <em>User Settings</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getSchemas <em>Schemas</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getExtendedData <em>Extended Data</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getServices <em>Services</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getLogs <em>Logs</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getOAuthAuthorizationCodes <em>OAuth Authorization Codes</em>}</li>
 *   <li>{@link cn.dlb.bim.models.store.impl.UserImpl#getOAuthIssuedAuthorizationCodes <em>OAuth Issued Authorization Codes</em>}</li>
 * </ul>
 *
 * @generated
 */
