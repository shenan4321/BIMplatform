...
public interface IRenderEngine extends AutoCloseable {
	/**
	 ...
	 * @throws RenderEngineException
	 */
	IRenderEngineModel openModel(InputStream inputStream, long size) throws RenderEngineException;
	 ...
	 * @throws RenderEngineException
	 */
	IRenderEngineModel openModel(InputStream inputStream) throws RenderEngineException;
